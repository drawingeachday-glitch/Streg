(function(){
  ...
  function installRewardStyles(){
    ...
    style.textContent = [
      ...
      '.streak-route-footer{justify-content:center!important;margin-top:14px;}',
      '.streak-journey-link{display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;width:min(100%,260px)!important;min-height:46px!important;padding:11px 22px!important;border:1px solid rgba(255,255,255,.14)!important;border-radius:999px!important;color:var(--streak-route-text)!important;background:linear-gradient(145deg,rgba(255,255,255,.13),rgba(255,255,255,.055))!important;box-shadow:inset 0 1px rgba(255,255,255,.1),0 10px 22px rgba(0,0,0,.16)!important;font-size:16px!important;font-weight:950!important;letter-spacing:.01em;opacity:1!important;backdrop-filter:blur(10px);}',
      '.streak-journey-link:hover{transform:translateY(-2px)!important;box-shadow:inset 0 1px rgba(255,255,255,.14),0 14px 28px rgba(0,0,0,.22),0 0 18px color-mix(in srgb,var(--streak-flame-main) 18%,transparent)!important;}',
      '.streak-journey-link svg{width:18px!important;height:18px!important;}',
      ...
      '@media(max-width:720px){.streak-command-hero{grid-template-columns:112px minmax(0,1fr)!important}.streak-command-hero .hero-flame-outline{width:112px!important;height:126px!important;margin-left:-6px!important}.streak-command-hero .hero-flame-num{font-size:40px!important;padding-top:16px!important}.streak-command-hero .hero-lr-title{font-size:29px!important}.streak-journey-link{width:min(100%,300px)!important;font-size:15px!important;min-height:44px!important}.streak-route-reward-badge{top:-6px;width:15px;height:15px}.streak-route-reward-badge svg{width:9px;height:9px}.streak-route-reward-label{font-size:6px}}',
      '@media(max-width:430px){.streak-command-hero{grid-template-columns:96px minmax(0,1fr)!important}.streak-command-hero .hero-flame-outline{width:104px!important;height:118px!important;margin-left:-7px!important}.streak-command-hero .hero-flame-num{font-size:38px!important;padding-top:15px!important}.streak-command-hero .hero-lr-title{font-size:26px!important}.streak-route-footer{margin-top:12px!important}.streak-journey-link{width:100%!important;min-height:42px!important;padding:10px 16px!important;font-size:14px!important}.streak-journey-link svg{width:17px!important;height:17px!important}}'
    ].join('');
