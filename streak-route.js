(function(){
  ...
  function installRewardStyles(){
    ...
    style.textContent = [
      ...
      '#tab-home .section-head:has(+ #featuredChallengeCard){position:relative!important;display:flex!important;justify-content:center!important;align-items:center!important;width:100%!important;min-height:52px!important;margin:30px 0 18px!important;padding:0 58px!important;box-sizing:border-box!important;}',
      '#tab-home .section-head:has(+ #featuredChallengeCard) .eyebrow{margin:0!important;color:var(--ink)!important;font-family:var(--font-display)!important;font-size:clamp(30px,6vw,42px)!important;font-weight:800!important;line-height:1!important;letter-spacing:-.035em!important;text-transform:none!important;text-align:center!important;}',
      '#tab-home .section-head:has(+ #featuredChallengeCard) .see-all{position:absolute!important;right:0!important;top:50%!important;transform:translateY(-50%)!important;}',
